                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <div class="card-text">
                                        ...
                                        <span class="badge badge-primary">Количество мест: ${eventInfo.capacity}</span>
                                        <span class="badge badge-secondary">Дата и время: ${eventInfo.start.local}</span>

                                        <a href="${eventInfo.url}" target="_blank" class="btn btn-primary btn-block mt-4">Получить билет!</a>
                                   </div>
                              </div>
                         </div>
                    </div>
